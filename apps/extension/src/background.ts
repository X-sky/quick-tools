...
import type { ExportFormat, MarkdownExportSource, RenderJob } from "@quick-tools/web-export"

import { initChromePlatform } from "~platform"
...
import type { BackgroundMessage, ExportStatus } from "~features/web-export/types"
import { createStatus, getTaskStorageKey, toDataUrl } from "~features/web-export/utils"

// Register platform adapter before any message handling
initChromePlatform()
